...
// (EQ = bleu de Prusse, l'encre des tirages).
...
namespace palette
{
    ...
    inline const juce::Colour spot     { 0xff5c85e6 };   // encre spot de l'EQ (bleu de Prusse)
}
...
// Dessine les cadrans "symbole schematique" et le commutateur rotatif LF
